...
var orderStore = new order_1.StoreOrder();
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, productId, quantity, addProdToOrder, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, orderStore.addProduct(quantity, Number(orderId), Number(productId))];
            case 2:
                addProdToOrder = _a.sent();
...
var order_routes = function (app) {
    ...
    app.get('/order/:id', verifyAuthToken_1["default"], show);
    app.post('/order', verifyAuthToken_1["default"], create);
    app.post('/orders/:id/product', verifyAuthToken_1["default"], addProduct);
};
