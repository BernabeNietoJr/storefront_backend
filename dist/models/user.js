...
var StoreUser = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot get Store Users " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find specific Store User " + id + ". Error: " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    StoreUser.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, hash, result, u, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not create new user " + user.user_name + ". Error " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
